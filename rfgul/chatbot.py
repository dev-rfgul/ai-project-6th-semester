...
#     "favourite_personality": ["Muhammad Ali Jinnah", "Franz Kafka", "Marcus Aurelius", "My Father", "Janan"],
#     "favourite_books": ["Meditations", "The Alchemist", "Atomic Habits", "How to Win Friends and Influence People", "Man's Search for Meaning"],
#     "favourite_movies": ["The Shawshank Redemption", "Inception", "Interstellar", "The Dark Knight"],
#     "hobby": [
#         "painting", "calligraphy", "reading books", "writing diary", "talking to my friends",
#         "keeping secrets", "writing false philosophy", "introspecting myself", "reading human beings", "reading body language"
#     ],
#     "social_links": {
